...
server.tool(
  ...
  async (input) => ({
    content: [{ type: 'text', text: JSON.stringify(await repo.createTrip(input, { type: 'mcp', idOrContext: 'create_trip' }), null, 2) }],
  })
);
...
server.tool(
  ...
  async (input) => ({
    content: [{ type: 'text', text: JSON.stringify(await repo.createFlight(input, { type: 'mcp', idOrContext: 'create_flight' }), null, 2) }],
  })
);
...
server.tool(
  ...
  async ({ flightId, tripId }) => ({
    content: [{ type: 'text', text: JSON.stringify(await repo.assignFlightToTrip(flightId, tripId, { type: 'mcp', idOrContext: 'assign_flight_to_trip' }), null, 2) }],
  })
);
...
server.tool(
  ...
  async ({ flightId }) => ({
    content: [{ type: 'text', text: JSON.stringify(await repo.markFlightNotFlown(flightId, { type: 'mcp', idOrContext: 'mark_flight_not_flown' }), null, 2) }],
  })
);
...
server.tool(
  ...
  { flightId: z.number().int() },
  async ({ flightId }) => ({
    content: [{ type: 'text', text: JSON.stringify(await repo.markFlightFlown(flightId, { type: 'mcp', idOrContext: 'mark_flight_flown' }), null, 2) }],
  })
);
...
server.tool(
  ...
  { flightId: z.number().int() },
  async ({ flightId }) => {
    await repo.deleteFlight(flightId, { type: 'mcp', idOrContext: 'delete_flight' });
